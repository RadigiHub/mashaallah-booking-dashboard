  ...
  return (
    ...
    >
      <div className="card" style={{ width: "100%", maxWidth: 1100 }}>
        ...
        >
          <div>
            <h1 style={{ margin: 0, fontSize: 34 }}>Umrah Package Builder</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row" style={{ marginBottom: 20 }}>
            ...
            <Field label="Quotation Status">
              <select className="input" value={quotationStatus} onChange={(e) => setQuotationStatus(e.target.value)}>
          ...
          <div style={{ marginBottom: 24 }}>
            <Field label="Flight Notes">
              <textarea className="input" rows={3} value={flightNotes} onChange={(e) => setFlightNotes(e.target.value)} placeholder="Transit / timings / baggage notes" />
            </Field>
          </div>
